...
## properties（物件テーブル）
※3/14 DBカラムを追加
・propertiesテーブルへペット可否、共益費、駐車場、築年数、敷金・礼金、管理会社情報、画像パス用カラムを追加
・物件詳細表示に備えてDBカラムを拡張し、画像パスの管理方針を相対パス保存に整理
...
---
※2026/3/12
- フォームのバリデーション追加（エリア、予算、間取り、入居希望日程）
- index.html内の機能実装一覧を分離しパーツ化（フラグメント）
- 機能一覧を簡単に視覚的に確認できるようモーダル実装。

---
※2026/3/14
- DBカラム追加
- 物件情報の一部の表示整形実施
- テスト表示のため、なるべく均等に絞り込み結果が出るよう物件情報修正

---
※2026/3/15
- CTAパーツセクションに戻るボタンを移動、管理できるように調整。
